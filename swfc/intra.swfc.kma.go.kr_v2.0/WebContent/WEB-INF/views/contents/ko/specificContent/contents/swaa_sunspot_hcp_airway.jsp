...
$(function(){ 
	$("#height").change(function() { 
		...
		var src = "<c:url value='/ko/specificContent/swaa_image.do?type=HCP_AIRWAY&airway="+selected+"'/>"; 
	    $("img").attr("src",src);		 
	}) 
})
...
<div style="position:absolute; top:5px; right:5px; background:white; color:black; border:1px solid white; z-index:1000">
	...
	<img src="<c:url value="/ko/specificContent/swaa_image.do?type=HCP_AIRWAY&airway=DEL-ICN"/>"/>
