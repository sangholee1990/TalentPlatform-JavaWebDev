  ...
  public static final long serialVersionUID = HObject.serialVersionUID;
    ...
    public HDFView(String root, List flist, int width, int height, int x, int y)
    {
       ...
       try { props.load();} catch (Exception ex){;}
        ...
        // need to call pack() before  any file so that 
        ...
        for (int i=0; i<nfiles; i++) {
            ...
            if (theFile.isFile()) {
                ...
                try {
                	System.out.println("HDFView.java 302 line -  treeView.openFile");
...
//        }
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (cmd.startsWith("Open file"))
        {
            ...
            try {
            	...
            	//System.out.println(filename + "," + fileAccessID);
    ...
    public static void main( String args[] )
    {
        ...
        System.out.println("rootDir:" + rootDir + ", flist:" + flist + ", W:" + W +", H:"+ H + ", X:" + X + ", Y:" + Y);
