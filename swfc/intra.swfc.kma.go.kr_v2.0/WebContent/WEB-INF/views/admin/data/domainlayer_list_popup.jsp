		...
		<div class="col-sm-12 col-md-12">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="domainlayer_list_popup.do" method="post" name="searchForm" id="searchForm">
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-3 text-left"><a href="javascript:goSelect(${o.dmn_layer_seq_n},'${o.dmn_layer_kor_nm}');"><spring:escapeBody>${o.dmn_layer_kor_nm}</spring:escapeBody></a></td>
...
$(function() {
	...
	$(paramForm).addHidden("mode", $("#mode").val());
...
function goSelect(seq, nm){
	...
	var re = window.opener.setDomainLayer(seq, nm);
