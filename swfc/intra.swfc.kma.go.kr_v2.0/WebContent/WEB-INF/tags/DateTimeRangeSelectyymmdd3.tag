...
<input type="text" size="12" id="sd3" value="<fmt:formatDate type="date" value="${startDate}" pattern="yyyy-MM-dd" timeZone="UTC"/>"/>
<select id="shour">
...
<select id="smin">
	<c:forEach begin="00" end="55" varStatus="loop" var="i" step="5">
		<option	value="<fmt:formatNumber minIntegerDigits="2" value="${i}"/>" <c:if test="${hour == i}">selected="selected"</c:if>><fmt:formatNumber minIntegerDigits="2" value="${i}" /></option>
	</c:forEach>
</select>분~
<input type="text" size="12" id="ed3" value="<fmt:formatDate type="date" value="${endDate}" pattern="yyyy-MM-dd" timeZone="UTC"/>"/>
<select id="ehour">
	<c:forEach begin="0" end="23" varStatus="loop" var="i">
		<option	value="<fmt:formatNumber minIntegerDigits="2" value="${i}"/>" <c:if test="${hour == i}">selected="selected"</c:if>><fmt:formatNumber minIntegerDigits="2" value="${i}" /></option>
	</c:forEach>
