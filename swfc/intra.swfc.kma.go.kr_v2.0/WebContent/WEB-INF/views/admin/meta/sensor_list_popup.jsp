		...
		<div class="col-sm-12 col-md-12">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="sensor_list_popup.do" method="post" name="searchForm" id="searchForm">
            ...
            <tr>
            	...
            	<td class="col-sm-4 text-left"><a href="javascript:goSelect(${o.clt_tar_sensor_seq_n},'${o.clt_tar_sensor_kor_nm}');"><spring:escapeBody>${o.clt_tar_sensor_kor_nm}</spring:escapeBody></a></td>
...
// 	$("#iPage").val(iPage);
// 	$("#searchForm").attr("action", "sensor_list_popup.do" );
// 	$("#searchForm").submit();
// }

function goSelect(seq, nm ){
	window.opener.setSensor(seq, nm);
	window.close();
}
