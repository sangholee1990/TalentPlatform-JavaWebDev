	...
	<div class="row">
        ...
        <table class="table table-condensed">
            <tr>
                ...
                <td><spring:escapeBody>${sensorDTO.clt_tar_sensor_kor_nm}</spring:escapeBody></td>                  
            </tr>
            <tr>
                <th class="active text-center">영문명</th>
                <td><spring:escapeBody>${sensorDTO.clt_tar_sensor_eng_nm}</spring:escapeBody></td>                  
            </tr>
            <tr>
                <th class="active text-center">사용여부</th>
                <td><spring:escapeBody><custom:UseYNConvert useYN="${sensorDTO.use_f_cd}"/></spring:escapeBody></td>                  
            </tr>
            <tr>
                <th class="active text-center">설명</th>
                <td><div class="custom-overflow"><spring:escapeBody>${sensorDTO.clt_tar_sensor_desc}</spring:escapeBody></div></td> 
            </tr>
        </table>
...
$(function() {
	...
	$("#contents :button").click(function() {
		...
		case "수정":
			...
			$(paramForm).attr("action", "sensor_form.do");
			$(paramForm).submit();
		...
		case "삭제":
			if(confirm("삭제하시겠습니까?")) {
				$(paramForm).attr("action", "sensor_del.do");
				$(paramForm).submit();
			}
			break;
		case "목록":
