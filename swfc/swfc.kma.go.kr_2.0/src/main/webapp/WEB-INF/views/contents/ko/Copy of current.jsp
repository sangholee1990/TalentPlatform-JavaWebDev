...
<link rel="stylesheet" type="text/css" href="<c:url value="/css/js/datetimepicker-master/jquery.datetimepicker.css"/>"  />
<style>
.dygraph-ylabel{
	font-weight: bold;
	color:white;
...
<script type="text/javascript" src="<c:url value="/css/js/datetimepicker-master/jquery.datetimepicker.js"/>"></script>
<script type="text/javascript" src="<c:url value="/css/js/date.format.js"/>"></script>
...
ImageManager.prototype.initialize = function(container) {
	...
	this.title = container.find(".top_con span.select_box").last();
	...
	//위성 레이어 선택
	this.container.find(".title .top_con .select_box").click(function(e) {
		imageSearchCalenar.hide();
...
ImageManager.prototype.updateData = function(data) {
	...
	if(data != null) {
		...
		if(this.viewMovie) {
			...
			this.image.attr("alt", "<c:url value="/element/view_movie.do"/>?id=" + data.id + "&size=512&frames=100");
		} else {
			this.image.attr("src", "<c:url value="/element/view_browseimage.do"/>?id=" + data.id);
			this.image.attr("alt", "<c:url value="/element/view_browseimage.do"/>?id=" + data.id);
		}
	} else {
...
<div id="wrap_current">
	...
	<div class="wrap_sun">
        <div class="cgroup s_sun" id="imageManager1">
        	<div class="title">
        		<div class="top_con">
        			 <span class="select_box on" name="SDO__01001">SOHO/LASCO C2</span><span class="t_date">2014.06.19 05:42</span> 
        			 <button class="cal"></button> 
        			 <button class="vod stop"></button> 
        		 </div>
        		<ul class="select_list" style="display: none;">
        			<li code="SDO_01001">SDO/AIA 0131</li>
        			<li code="SDO_01002">SDO/AIA 0171</li>
        			<li code="SDO_01003">SDO/AIA 0193</li>
        			<li code="SDO_01004">SDO/AIA 0211</li>
        			<li code="SDO_01005">SDO/AIA 0304</li>
        			<li code="SDO_01006">SDO/AIA 1600</li>
        			<li code="SOHO_01001">SOHO/LASCO C2</li>
        			<li code="SOHO_01002">SOHO/LASCO C3</li>
        			<li code="STA_01001">STA/COR1</li>
        			<li code="STA_01002">STA/COR2</li>
        			<li code="STB_01001">STB/COR1</li>
        			<li code="STB_01002">STB/COR2</li>
        		</ul>
        		<!-- 
        ...
        <div class="cgroup s_sun" id="imageManager2">
        	<div class="title">
            	<div class="top_con">
        			 <span class="select_box  on" name="SDO__01002">SOHO/LASCO C2</span><span class="t_date">2014.06.19 05:42</span> 
        			 <button class="cal"></button> 
        			 <button class="vod play"></button> 
        		</div>
        		<ul class="select_list" style="display: none;">
        			<li code="SDO_01001">SDO/AIA 0131</li>
        			<li code="SDO_01002">SDO/AIA 0171</li>
        ...
        <div class="cgroup s_sun" id="imageManager3">
        	<div class="title">
        		<div class="top_con">
        			<span class="select_box on" name="SDO__01003">SOHO/LASCO C2</span><span class="t_date">2014.06.19 05:42</span> 
        			<button class="cal"></button> 
        			<button class="vod stop"></button> 
        		 </div>
        		<ul class="select_list" style="display: none;">
        ...
        <div class="cgroup s_sun" id="imageManager4">
        	<div class="title">
        		<div class="top_con">
        			<span class="select_box on" name="SDO__01004">SOHO/LASCO C2</span><span class="t_date">2014.06.19 05:42</span> 
        			 <button class="cal"></button> 
        			 <button class="vod stop"></button> 
        		 </div>
        		<ul class="select_list" style="display: none;">
    ...
    <div class="wrap_forecast">
        ...
        <div class="group s_alert">
            <p class="title">
            	<img src="<c:url value="/images/main_title_rad.png"/>" alt="태양복사폭풍" />
            </p>
			<div class="info">
        ...
        <div class="group">
            <p class="title">
            	<img src="<c:url value="/images/main_title_par.png"/>" alt="태양입자폭풍" />
            </p>
			<div class="info">
        ...
        <div class="group">
            <p class="title">
            	<img src="<c:url value="/images/main_title_ter.png"/>" alt="지자기폭풍" />
            </p>
			<div class="info">
        ...
        <div class="group">
            <p class="title">
            	<img src="<c:url value="/images/main_title_mag.png"/>" alt="자기권계면" />
            </p>
			<div class="info">
...
<div class="layer" style="top:955px; left:595px;display:none;" id="calendar_time_layer">
	<div class="layer_contents">
    	<p>
        	<label>날짜</label>
        	<input type="text" size="12" id="calendar_search_date" value="<fmt:formatDate value="${endDate}" pattern="yyyy-MM-dd" timeZone="UTC"/>"/>      
        </p>
        <p>
        	<label>시</label>
        	<select>
        		<c:forEach begin="0" end="23" step="1" var="hour">
        			<c:if test="${hour lt 10}">
	       			<option value="0${hour}">0${hour}</option>
	       			</c:if>
	       			<c:if test="${hour gt 10}">
	       			<option>${hour}</option>
	       			</c:if>
        		</c:forEach>
        	</select>
        ...
        <p>
        	<label>분</label>
        	<select>
       		<c:forEach begin="0" end="59" step="1" var="min">
       			<c:if test="${min lt 10}">
