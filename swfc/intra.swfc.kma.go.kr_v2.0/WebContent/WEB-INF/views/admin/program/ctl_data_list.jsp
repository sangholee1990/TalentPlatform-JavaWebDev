			...
			<!-- content area start -->
				...
				<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="ctl_data_list.do" method="post" name="listForm" id="listForm">
				...
				<div class="top-button-group">
					<input type="button" class="btn btn-primary btn-sm addBtn" title="자료등록" value="자료등록" />
				</div>
		        ...
		        <table class="table table-striped">
					...
					<tbody>
						...
						<tr>
		                	...
		                	<td>${o.CLT_DTA_SEQ_N }</td>
		                	<td><a href="ctl_data_form.do?clt_dta_seq_n=${o.CLT_DTA_SEQ_N }">${o.DTA_NM}</a></td>
