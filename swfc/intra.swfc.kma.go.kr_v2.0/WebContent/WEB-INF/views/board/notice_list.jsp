...
<div id="contents">
	...
	<div class="search_wrap">    
        <div class="search">
        	<form class="navbar-form navbar-right" action="notice_list.do" method="post" name="searchForm" id="searchForm">
            ...
            <c:choose>
            	...
            	<c:otherwise>
		            ...
		            <tr>
		            	...
		            	<td><a href="notice_view.do?board_seq=${o.board_seq}&iPage=${pageNavigation.nowPage}"><spring:escapeBody htmlEscape="true">${o.title}</spring:escapeBody></a>
