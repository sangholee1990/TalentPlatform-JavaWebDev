...
public class ForecastReportDTO implements Serializable {
	...
	public String getXrayGrade() {
		return ChartSummaryDTO.getGrade(ChartSummaryDTO.DataType.XRAY, xray);
	}
	public String getProtonGrade() {
		return ChartSummaryDTO.getGrade(ChartSummaryDTO.DataType.PROTON, proton);
	}
	public String getKpGrade() {
		return ChartSummaryDTO.getGrade(ChartSummaryDTO.DataType.KP, kp);
	}
	public String getMpGrade() {
		return ChartSummaryDTO.getGrade(ChartSummaryDTO.DataType.MP, mp);
	}
