    ...
    <div class="search_wrap">
        ...
        <div class="search detail">
            <p class="type">
                ...
                <span><input name="" type="checkbox" value="" /> X-선 플럭스</span>
                <span><input name="" type="checkbox" value="" /> 양성자 플럭스</span>
                <span><input name="" type="checkbox" value="" /> Kp지수</span>
                <span><input name="" type="checkbox" value="" /> 자기권계면</span>
            </p>
        </div>
    </div>
    	...
    	<table>
            ...
            <tbody>
            	<tr>
                	<th>06</th>
                    <td>
                        <img src="../images/test_aia0171.jpg" class="imgbtn" />
                    </td>
                    <td>
                        <img src="../images/test_aia0171.jpg" class="imgbtn" />
                    </td>
