...
$(function() {
	...
	$('.listBtn').on('click', function(){
		location.href = "notice_list.do?iPage=${param.iPage}";
	});
});
</script>
</head>
            ...
            <tr>
                ...
                <td>
                 <c:forEach var="file" items="${fileList}">
              		<a href="download.do?board_file_seq=${file.board_file_seq}"><spring:escapeBody>${file.filename}</spring:escapeBody></a><br/>
              	  </c:forEach>
				</td>              	  
            </tr>
        </table>
