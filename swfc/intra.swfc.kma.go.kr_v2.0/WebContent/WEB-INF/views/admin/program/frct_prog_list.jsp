			...
			<!-- content area start -->
				...
				<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="frct_prog_list.do" method="post" name="listForm" id="listForm">
				...
				<div class="top-button-group">
					<input type="button" class="btn btn-primary btn-sm addBtn" title="예측모델프로그램등록" value="예측모델프로그램등록" />
				</div>
		        ...
		        <table class="table table-striped">
					...
					<tbody>
						...
						<tr>
		                	...
		                	<td>${o.FRCT_PROG_SEQ_N}</td>
		                	<td><a href="frct_prog_form.do?frct_prog_seq_n=${o.FRCT_PROG_SEQ_N}">${o.PROG_NM}</a></td>
