		...
		<div class="col-sm-12 col-md-12">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="datakind_list_popup.do" method="post" name="listForm" id="listForm">
				    	...
				    	<div class="form-group">
				    		...
				    		<select class="form-control input-sm"   name="search_target" id="search_target" title="검색">
								...
								<option value="dta_knd_kor_nm" <c:if test="${searchInfo.search_target eq 'dta_knd_kor_nm'}">selected="selected"</c:if> >한글명</option>
								<option value="dta_knd_eng_nm" <c:if test="${searchInfo.search_target eq 'dta_knd_eng_nm'}">selected="selected"</c:if> >영문명</option>
							</select>
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-2 text-left"><a href="javascript:goSelect(${o.dta_knd_seq_n},'${o.dta_knd_kor_nm}','${o.dmn_kor_nm}', '${o.dmn_sub_kor_nm}');"><spring:escapeBody>${o.dta_knd_kor_nm}</spring:escapeBody></a></td>
...
//자료종류 설정
function goSelect(seq, nm, dmnNm, dmnSubNm){
	window.opener.setDataKind(seq, nm, dmnNm, dmnSubNm);
	window.close();
}
