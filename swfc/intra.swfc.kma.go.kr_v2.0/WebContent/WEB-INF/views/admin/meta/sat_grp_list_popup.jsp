	...
	<div class="col-sm-12 col-md-12">
    		...
    		<nav class="navbar navbar-default" role="navigation">
				<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
			    	<form class="navbar-form navbar-right" role="search" action="sat_grp_list_popup.do" method="post" name="searchForm" id="searchForm">
    		...
    		<table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-4 text-left"><a href="javascript:goSelect(${o.clt_tar_grp_seq_n},'${o.clt_tar_grp_kor_nm}');"><spring:escapeBody>${o.clt_tar_grp_kor_nm}</spring:escapeBody></a></td>
	                <td class="col-sm-4 text-left"><spring:escapeBody>${o.clt_tar_grp_eng_nm}</spring:escapeBody></td>
			...
			<div class="text-center">
			   <ul class="pagination pagination-sm">
			        ...
			        <c:forEach var="page" begin="${pageNavigation.startPage}" end="${pageNavigation.endPage}">
			        	<li <c:if test="${page ne pageNavigation.nowPage}">class="active"</c:if>><a href="javascript:goPage(${page});">${page}</a></li>
			        </c:forEach>
...
// 	$("#iPage").val(iPage);
// 	$("#searchForm").attr("action", "sat_grp_list_popup.do");
// 	$("#searchForm").submit();
// }

// 수집대상 그룹 설정
function goSelect(seq, nm ){
	window.opener.setGroup(seq, nm);
	window.close();
}
</script>
