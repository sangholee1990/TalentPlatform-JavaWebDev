<%@ page language="java" contentType="text/html;charset=utf-8" pageEncoding="UTF-8" trimDirectiveWhitespaces="true"
	import="java.util.*,com.gaia3d.web.dto.CoverageDTO,org.springframework.util.*"
...
<div id="contents" class="container">
	...
	<div class="row">
		...
		<div class="col-sm-10 col-md-10">
			...
			<form:form commandName="coverageDTO" action="coverage_submit.do" method="post" class="form-horizontal" role="form">
				<input type="hidden" name="coverage_seq_n" value="${coverageDTO.coverage_seq_n}"/>
				...
				<div class="form-group form-group-sm">
			    	<label for="coverage_cd" class="col-sm-2 control-label">코드</label>
			    	<div class="col-sm-5">
			      		<form:input path="coverage_cd" class="form-control"/>
			    	</div>
			  	</div>
				
				<div class="form-group form-group-sm">
			    	<label for="coverage_kor_nm" class="col-sm-2 control-label">한글명</label>
			    	<div class="col-sm-5">
			      		<form:input path="coverage_kor_nm" class="form-control"/>
			    	</div>
			  	</div>
	  	
				<div class="form-group form-group-sm">
			    	<label for="coverage_eng_nm" class="col-sm-2 control-label">영문명</label>
			    	<div class="col-sm-5">
			      		<form:input path="coverage_eng_nm" class="form-control"/>
			    	</div>
			  	</div>
				...
				<div class="form-group">
			    	<label for="coverage_desc" class="col-sm-2 control-label">설명</label>
			    	<div class="col-sm-5">
			      		<form:textarea path="coverage_desc" class="form-control" rows="5"/>
			      	</div>
			  	</div>	  	
...
$(function() {
	...
	$(paramForm).find('input[type=hidden]').each(function() {
		$("#coverageDTO").addHidden($(this).attr("id"), $(this).val());
	});
