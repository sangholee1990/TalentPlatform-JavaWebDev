		...
		<div class="col-sm-10 col-md-10">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="domainsub_list.do" method="post" name="searchForm" id="searchForm">
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-3 text-left"><a href="javascript:goView(${o.dmn_sub_seq_n});"><spring:escapeBody>${o.dmn_sub_kor_nm}</spring:escapeBody></a></td>
...
$(function() {
	...
	$("#regBtn").click(function() {
		location.href="domainsub_form.do?mode=new";
	});
