		...
		<div class="col-sm-12 col-md-12">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="domaindatamapping_list_popup.do" method="post" name="searchForm" id="searchForm">
		...
		<br /> <br/>
				    	...
				    	<div class="form-group">
				    		...
				    		<select class="form-control input-sm"   name="search_target" id="search_target" title="검색">
								...
								<option value="dmn_kor_nm" <c:if test="${searchInfo.search_target eq 'dmn_kor_nm'}">selected="selected"</c:if> >도메인</option>
								<option value="dmn_sub_kor_nm" <c:if test="${searchInfo.search_target eq 'dmn_sub_kor_nm'}">selected="selected"</c:if> >도메인 서브</option>
								<option value="dmn_layer_kor_nm" <c:if test="${searchInfo.search_target eq 'dmn_layer_kor_nm'}">selected="selected"</c:if> >도메인레이어</option>
								<option value="dta_knd_kor_nm" <c:if test="${searchInfo.search_target eq 'dta_knd_kor_nm'}">selected="selected"</c:if> >자료종류</option>
								<option value="dta_knd_inside_kor_nm" <c:if test="${searchInfo.search_target eq 'dta_knd_inside_kor_nm'}">selected="selected"</c:if> >자료종류 내부</option>
							</select>
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td><a href="javascript:goSelect(${o.dmn_seq_n},
	            						 ${o.dmn_layer_seq_n}, 
	            						 ${o.dmn_sub_seq_n},
	            						 ${o.dta_knd_seq_n}, 
	            						 ${o.dta_knd_inside_seq_n},
	            						 '${o.dta_knd_inside_kor_nm}',
	            						 '${o.dmn_kor_nm}',
	            						 '${o.dmn_sub_kor_nm}',
	            						 '${o.dmn_layer_kor_nm}',
	            						 '${o.dta_knd_kor_nm}');"><spring:escapeBody>${o.dta_knd_inside_kor_nm}</spring:escapeBody></a></td>
...
function goSelect(dmn_seq_n,
	...
	window.opener.setDomainDataMapping(dmn_seq_n,
			dmn_layer_seq_n, 
			dmn_sub_seq_n,
			dta_knd_seq_n,
			dta_knd_inside_seq_n,
