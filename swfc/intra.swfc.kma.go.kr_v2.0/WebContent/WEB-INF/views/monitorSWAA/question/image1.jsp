...
<body> 
		<div class="queTitle">
		<font size="6">자기권계면 위치 도움말</font>
		</div>  
		<div class="queTable">
		<font size="4"> 
	태양풍의 변화에 따른 자기권계면의 위치를 나타낸 그림이다. 자기권계면은 태양풍에 의한 위험으로부터 정지궤도 위성을 보호한다. 안쪽 노란색 점선으로 나타낸 원은 정지궤도의 위치를 나타내며 자기권계면의 위치가 정지궤도 보다 안쪽에 위치할 경우 기상위성운영에 특보가 발령된다. 정지궤도 위성의 안정적 운영을 위해 자기권계면 위치에 따라 위험수준를 5단계로 나누어 자기권계면 위치를 감시하고 있다. 그림은 1분 주기로 업데이트 된다. 
		</font>
		<br></br>
		<table align="center">
			<tr>
