...
public class SatGroupDTO implements Serializable {

	private static final long serialVersionUID = 5306858053560069381L;

	private Integer clt_tar_grp_seq_n    ;     //수집대상그룹일련번호

	@NotBlank
	private String clt_tar_grp_kor_nm   ;     //수집대상그룹한글명
	@NotBlank
	private String clt_tar_grp_eng_nm   ;     //수집대상그룹영문명

	private String clt_tar_grp_desc     ;     //수집대상그룹설명
	...
	private String clt_tar_grp_cd       ;     //코드정보
	...
	public String getClt_tar_grp_desc() {
		return clt_tar_grp_desc;
	}
	public void setClt_tar_grp_desc(String clt_tar_grp_desc) {
		this.clt_tar_grp_desc = clt_tar_grp_desc;
	}
	...
	public String getClt_tar_grp_cd() {
		return clt_tar_grp_cd;
	}
	public void setClt_tar_grp_cd(String clt_tar_grp_cd) {
		this.clt_tar_grp_cd = clt_tar_grp_cd;
	}
