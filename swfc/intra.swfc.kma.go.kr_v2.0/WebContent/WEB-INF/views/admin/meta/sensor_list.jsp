		...
		<div class="col-sm-10 col-md-10">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" method="post" action="sensor_list.do" name="searchForm" id="searchForm">
				    	...
				    	<div class="form-group">
				    		...
				    		<select class="form-control input-sm"   name="search_target" id="search_target" title="검색">
								...
								<option value="clt_tar_sensor_kor_nm" <c:if test="${param.search_target eq 'clt_tar_sensor_kor_nm'}">selected="selected"</c:if> >한글명</option>
								<option value="clt_tar_sensor_eng_nm" <c:if test="${param.search_target eq 'clt_tar_sensor_eng_nm'}">selected="selected"</c:if> >영문명</option>
							</select>
   		    ...
   		    <div class="top-button-group">
				<input type="button" class="btn btn-primary btn-sm" id="regBtn" title="센서등록" value="등록" />
			</div>
    		...
    		<table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-4 text-left"><a href="javascript:goView(${o.clt_tar_sensor_seq_n});"><spring:escapeBody>${o.clt_tar_sensor_kor_nm}</spring:escapeBody></a></td>
	                <td class="col-sm-4 text-left"><spring:escapeBody>${o.clt_tar_sensor_eng_nm}</spring:escapeBody></td>
...
$(function() {
	$("#regBtn").click(function() {
		location.href="sensor_form.do?mode=new";
	});
});
...
// 	$("#iPage").val(iPage);
// 	$("#searchForm").attr("action","sensor_list.do");
// 	$("#searchForm").submit();
// }

//상세보기
function goView(clt_tar_sensor_seq_n){
