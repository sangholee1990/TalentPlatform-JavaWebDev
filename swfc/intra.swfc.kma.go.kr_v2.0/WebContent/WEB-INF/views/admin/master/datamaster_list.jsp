		...
		<div class="col-sm-10 col-md-10">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="datamaster_list.do" method="post" name="searchForm" id="searchForm">
						...
						<input type="hidden" name="search_dta_knd_inside_seq_n" id="search_dta_knd_inside_seq_n" value="${param.search_dta_knd_inside_seq_n}" />
				    		
				    	<div class="form-group has-feedback">
					    	<label for="search_dmn_kor_nm" class="control-label">도메인</label>
					      	<input class="form-control input-sm" name="search_dmn_kor_nm" id="search_dmn_kor_nm" type="text" value="${param.search_dmn_kor_nm}" class="form-control" readonly="true" style="width: 150px;"/>
				      	...
				      	<div class="form-group has-feedback">
					    	<label for="search_dmn_sub_kor_nm" class="control-label">도메인서브</label>
					      	<input class="form-control input-sm" name="search_dmn_sub_kor_nm" id="search_dmn_sub_kor_nm" type="text" value="${param.search_dmn_sub_kor_nm}" class="form-control" readonly="true" style="width: 150px;"/>
						...
						<div class="form-group has-feedback">
					    	<label for="search_dmn_layer_kor_nm" class="control-label">도메인레이어 </label>
					      	<input class="form-control input-sm" name="search_dmn_layer_kor_nm" id="search_dmn_layer_kor_nm" type="text" value="${param.search_dmn_layer_kor_nm}" class="form-control" readonly="true" style="width: 150px;"/>
				      	...
				      	<div class="form-group has-feedback">
					    	<label for="search_dta_knd_kor_nm" class="control-label">자료종류</label>
					      	<input class="form-control input-sm" name="search_dta_knd_kor_nm" id="search_dta_knd_kor_nm" type="text" value="${param.search_dta_knd_kor_nm}" class="form-control" readonly="true" style="width: 150px;"/>
				      	...
				      	<div class="form-group has-feedback">
					    	<label for="search_dta_knd_inside_kor_nm" class="control-label">자료종류내부</label>
					      	<input class="form-control input-sm" name="search_dta_knd_inside_kor_nm" id="search_dta_knd_inside_kor_nm" type="text" value="${param.search_dta_knd_inside_kor_nm}" class="form-control" readonly="true" style="width: 150px;"/>
				      	...
				      	<div class="form-group">
				        	...
				        	<select class="form-control input-sm" onchange="changeUseYN();"  name="search_use" id="search_use" title="사용여부">
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	                ...
	                <td>${o.clt_dta_mstr_seq_n}</td>
	            	<td><a href="javascript:goView(${o.clt_dta_mstr_seq_n});">${o.mstr_nm}</a></td>
	            	<!-- 
	            	...
	            	<td><a href="javascript:goView(${o.clt_dta_mstr_seq_n});"><spring:escapeBody>${o.dta_knd_inside_kor_nm}</spring:escapeBody></a></td>
	            	 -->
	                ...
	                <td>
	                	<a href="<c:url value="/admin/master/datamaster_form.do?mode=update&view_clt_dta_mstr_seq_n=${o.clt_dta_mstr_seq_n}"/>" class="btn btn-primary btn-xs">수정</a>
	                	<a href="javascript:goView(${o.clt_dta_mstr_seq_n});" class="btn btn-primary btn-xs">보기</a>
	                </td>
	            </tr>
	            </c:forEach>
	        </table>
...
$(function() {
	...
	$("#regBtn").click(function() {
		location.href="datamaster_form.do?mode=new";
	});

});

//매핑 수정
function goView(clt_dta_mstr_seq_n ){

	$(paramForm).addHidden("view_clt_dta_mstr_seq_n", clt_dta_mstr_seq_n);
