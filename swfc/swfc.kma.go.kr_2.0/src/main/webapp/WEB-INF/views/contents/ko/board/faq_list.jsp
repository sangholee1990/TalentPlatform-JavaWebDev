...
function goView(board_seq){
	$(paramForm).addHidden("view_board_seq", board_seq);
	$(paramForm).attr("action", "faq_view.do");
	$(paramForm).submit();
}
</script>
</head>
...
<div id="wrap_sub">
    ...
    <div id="faq">
		...
		<form name="searchForm" id="searchForm" action="faq_list.do"  method="post">
		...
		<table summary='자주묻는질문' class="list">
			<caption class='txt_hidden'>FAQ</caption>
			<colgroup>
				<col width='10%'/>
				<col width='60%'/>
				<col width='10%'/>
