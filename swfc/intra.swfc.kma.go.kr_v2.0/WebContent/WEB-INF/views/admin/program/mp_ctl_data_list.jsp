			...
			<!-- content area start -->
				...
				<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="mp_ctl_data_list.do" method="post" name="listForm" id="listForm">
				    	...
				    	<div class="form-group">
				    		...
				    		<select class="form-control input-sm" name="search_type" id="search_type">
				    			<option>전체</option>
				    			<option value="dta_nm" <c:if test="${param.search_type eq 'dta_nm'}">selected='selected'</c:if>>자료명</option>
				    			<option value="dta_path" <c:if test="${param.search_type eq 'dta_path'}">selected='selected'</c:if>>경로</option>
				    		</select>
				      	</div>
				      	<div class="form-group">
		        ...
		        <table class="table table-striped">
					...
					<tbody>
						...
						<tr>
		                	...
		                	<td><a href="mp_ctl_data_form.do?clt_dta_mstr_seq_n=${o.CLT_DTA_MSTR_SEQ_N }">${o.CLT_DTA_MSTR_SEQ_N }</a></td>
		                	<td><a href="mp_ctl_data_form.do?clt_dta_mstr_seq_n=${o.CLT_DTA_MSTR_SEQ_N }">${o.MSTR_NM}</a></td>
...
$(function() {
	...
	$('.addBtn').on('click', function(){
		location.href = "ctl_data_form.do";
	});
