...
public class BandGroupDTO implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -622033671635770834L;

	private Integer clt_tar_band_grp_seq_n   ; //수집대상밴드그룹일련번호

	@NotBlank
	private String clt_tar_band_grp_kor_nm  ; //수집대상밴드그룹한글명
	@NotBlank
	private String clt_tar_band_grp_eng_nm  ; //수집대상밴드그룹영문명

	private String clt_tar_band_grp_desc    ; //수집대상밴드그룹설명
	...
	private String clt_tar_band_grp_cd          ; //코드
	...
	public String getClt_tar_band_grp_desc() {
		return clt_tar_band_grp_desc;
	}
	public void setClt_tar_band_grp_desc(String clt_tar_band_grp_desc) {
		this.clt_tar_band_grp_desc = clt_tar_band_grp_desc;
	}
	...
	public String getClt_tar_band_grp_cd() {
		return clt_tar_band_grp_cd;
	}
	public void setClt_tar_band_grp_cd(String clt_tar_band_grp_cd) {
		this.clt_tar_band_grp_cd = clt_tar_band_grp_cd;
	}
}
