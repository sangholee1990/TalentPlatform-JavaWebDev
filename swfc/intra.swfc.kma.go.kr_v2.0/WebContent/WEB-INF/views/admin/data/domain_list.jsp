		...
		<div class="col-sm-10 col-md-10">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="domain_list.do" method="post" name="searchForm" id="searchForm">
				    	...
				    	<div class="form-group">
				    		...
				    		<select class="form-control input-sm"   name="search_target" id="search_target" title="검색">
								...
								<option value="dmn_kor_nm" <c:if test="${param.search_target eq 'dmn_kor_nm'}">selected="selected"</c:if> >한글명</option>
								<option value="dmn_eng_nm" <c:if test="${param.search_target eq 'dmn_eng_nm'}">selected="selected"</c:if> >영문명</option>
							</select>
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-4 text-left"><a href="javascript:goView(${o.dmn_seq_n});"><spring:escapeBody>${o.dmn_kor_nm}</spring:escapeBody></a></td>
	                <td class="col-sm-4 text-left"><spring:escapeBody>${o.dmn_eng_nm}</spring:escapeBody></td>
...
$(function() {
	$("#regBtn").click(function() {
		location.href="domain_form.do?mode=new";
	});
