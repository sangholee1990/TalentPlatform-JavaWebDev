...
<script type="text/javascript">
   function ExcelUpload() {
		...
		if(confirm("업로드 하시겠습니까?")) {
			uploadForm.action="user_sms_excel_upload.do";
			uploadForm.submit();
		}
   }
...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12 col-md-12">
			<h4 class="page-header">SMS 수신자 엑셀파일 업로드</h4>
			<!-- content area start -->
			...
			<form class="form-horizontal" name="uploadForm" id="uploadForm" method="post" enctype="multipart/form-data">
			    ...
			    <div align=center><font color="red" size="2">* 이름(15) 연락처(15) 소속(50) 사용여부 (1) byte까지 입력가능합니다.</font></div>
