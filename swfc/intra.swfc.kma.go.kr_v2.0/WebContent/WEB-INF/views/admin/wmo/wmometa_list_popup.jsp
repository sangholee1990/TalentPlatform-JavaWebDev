		...
		<div class="col-sm-12 col-md-12">
    		...
    		<table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-4 text-left"><a href="javascript:goSelect(${o.metadataseqn},'${o.fileidentifier}');"><spring:escapeBody>${o.fileidentifier}</spring:escapeBody></a></td>
...
function goSelect(seq,nm){
	window.opener.setWmoMeta(seq, nm);
	window.close();
}
