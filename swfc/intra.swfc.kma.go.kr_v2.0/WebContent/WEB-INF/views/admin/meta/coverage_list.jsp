		...
		<div class="col-sm-10 col-md-10">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" method="post" action="coverage_list.do"  name="searchForm" id="searchForm">
   		    ...
   		    <div class="top-button-group">
				<input type="button" class="btn btn-primary btn-sm" id="regBtn" title="범위등록" value="등록" />
			</div>
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-4 text-left"><a href="javascript:goView(${o.coverage_seq_n});"><spring:escapeBody>${o.coverage_kor_nm}</spring:escapeBody></a></td>
...
$(function() {
	$("#regBtn").click(function() {
		location.href="coverage_form.do?mode=new";
	});
});
...
// 	$("#iPage").val(iPage);
// 	$("#searchForm").attr("action","coverage_list.do");
// 	$("#searchForm").submit();	
// }

//상세보기
function goView(coverage_seq_n){
	
	$("#searchForm").addHidden("view_coverage_seq_n", coverage_seq_n);
	$("#searchForm").attr("action","coverage_view.do");
	$("#searchForm").submit();
}
</script>
</body>
