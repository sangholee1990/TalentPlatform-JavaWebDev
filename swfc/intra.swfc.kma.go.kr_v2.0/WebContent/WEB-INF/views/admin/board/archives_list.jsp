		...
		<div class="col-sm-10 col-md-10">
    		...
    		<nav class="navbar navbar-default" role="navigation">
				<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
			    	<form class="navbar-form navbar-right" role="search" action="<c:url value="/admin/board/archives_list.do"/>" method="post" name="searchForm" id="searchForm">
			    	<input type="hidden" name="iPage" id="iPage" value="${pageNavigation.nowPage}">
			      	...
			      	<div class="form-group">
			    		<label for="site_code_cd" class="control-label">자료 구분</label>
	            		<select class="form-control input-sm"  name="board_section_cd" id="board_section_cd" title="검색">
	            			<option value="">[전체]</option>
    		...
    		<table class="table table-striped">
            	...
            	<c:otherwise>
		            ...
		            <tr>
		                ...
		                <td class="text-left"><a href="javascript:goView(${o.board_seq});"><spring:escapeBody>${o.title}</spring:escapeBody></a><c:if test="${ o.is_new  eq 'Y'}"><span class="label label-default">N</span></c:if></td>
		                <td>${o.hit }</td>
...
$(function() { //html 문서가 처음 로딩 되고 난후 실행되는 init 함수
	...
	$(".addBtn").click(function() {
		location.href="archives_form.do";
	});
