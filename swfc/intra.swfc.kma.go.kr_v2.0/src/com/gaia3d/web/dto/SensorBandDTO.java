...
public class SensorBandDTO {

	private Integer clt_tar_sensor_seq_n ; // 수집대상센서일련번호
	private String clt_tar_sensor_kor_nm ; // 수집대상센서명
	private Integer clt_tar_band_seq_n   ; // 수집대상밴드일련번호
	private String clt_tar_band_kor_nm   ; // 수집대상밴드명
	private String clt_tar_band_grp_kor_nm   ; // 수집대상밴드그룹명
