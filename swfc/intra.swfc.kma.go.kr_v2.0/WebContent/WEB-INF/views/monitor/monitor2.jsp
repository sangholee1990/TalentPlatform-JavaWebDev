...
<div id="wrap">
	...
	<div id="contents">
		<div id="wrap_left">
		        ...
		        <div class="gr_img" id="imageManager1">
		            <div class="header">
		                <h2 id="atitle">
		                    <div id="imageText1" class="imageHeader"><a href="#" class="on" name="SDO__01001">방사선 순간 피폭량(고도 15km)</a></div>
		                </h2>
		                <div class="combo alist">					
		                    <a href="#" name="<c:out value="0"/>"><div id="image1Header">방사선 순간 피폭량(고도 0km)</div></a>
		                    <a href="#" name="<c:out value="5"/>"><div id="image2Header">방사선 순간 피폭량(고도 5km)</div></a>
		                    <a href="#" name="<c:out value="10"/>"><div id="image3Header">방사선 순간 피폭량(고도 10km)</div></a>
		                    <a href="#" name="<c:out value="15"/>"><div id="image4Header">방사선 순간 피폭량(고도 15km)</div></a>
		                </div>
		               <p class="date">		
		               		<span></span>	                   
		            ...
		            <div class="contents" id="image1">
		              <img src="http://localhost:8080/VImage/SWAA/SUNSPOT/HCP_WORLD/Y${year}/M${month}/D${date}/hcp_world_100.jpg" width="300" height="300"  onERROR="alert('이미지가 로드되지 않았습니다.')"/> <br>	
		            </div>
	...
	태양영상 2 --><div class="gr_img" id="imageManager2">
		            <div class="header">
		                 <h2 id="atitle">
		                    <div id="imageText2"><a href="#" class="on" name="SDO__01001">항공로별 순간 피폭량 [뉴욕-인천(polar)]</a></div>
		                </h2>
		                <div class="combo alist">	                    
				              <a href="#" name="<c:out value="0"/>"><div id="image2-1">항공로별 순간 피폭량 [LA-인천]</div></a>
				              <a href="#" name="<c:out value="0"/>"><div id="image2-2">항공로별 순간 피폭량 [뉴욕-인천]</div></a>
				              <a href="#" name="<c:out value="0"/>"><div id="image2-3">항공로별 순간 피폭량 [뉴욕-인천(polar)]</div></a>
				              <a href="#" name="<c:out value="0"/>"><div id="image2-4">항공로별 순간 피폭량 [댈러스-인천]</div></a>
				              <a href="#" name="<c:out value="0"/>"><div id="image2-5">항공로별 순간 피폭량 [모스크바-인천]</div></a>
				              <a href="#" name="<c:out value="0"/>"><div id="image2-6">항공로별 순간 피폭량 [시애틀-인천]</div></a>
				              <a href="#" name="<c:out value="0"/>"><div id="image2-7">항공로별 순간 피폭량 [이스탄불-인천]</div></a>
				              <a href="#" name="<c:out value="0"/>"><div id="image2-8">항공로별 순간 피폭량 [인천-런던]</div></a>
				              <a href="#" name="<c:out value="0"/>"><div id="image2-9">항공로별 순간 피폭량 [파리-인천]</div></a> 
		                </div>
		                <p class="date">
		                    <span></span>
		                    <a href="#" class="calendar"><span>달력</span></a>
		            ...
		            <div class="contents" id="image2">
		         	<img src="http://localhost:8080/VImage/SWAA/SUNSPOT/HCP_AIRWAY/Y${year}/M${month}/D${date}/JFK-ICN-polar.jpg" width="300" height="300" onERROR="alert('이미지가 로드되지 않았습니다.')"/> <br>	
		            </div>
		        </div><!-- 
	태양영상 3  --><div class="gr_img" id="imageManager3">
		            <div class="header">
		                 <h2>
		                    <a href="#" class="on" name="SDO__01003">극항로 통신 두절 영역(극관크기) </a> 
		                </h2>       
		                <p class="date">
		                    <span></span> 
		                  	<a href="#" class="calendar"><span>달력</span></a>
		            ...
		            <img src="http://localhost:8080/VImage/SWAA/OVATION/OVATION/Y${year}/M${month}/D${date}/ovation_world_0000.jpg" width="300" height="300" onERROR="alert('이미지가 로드되지 않았습니다.')"/> <br> 
		            </div>
		        </div><!-- 
	태양영상 4  --><div class="gr_img" id="imageManager4">
		           ...
		           <div class="contents" id="image4">
		              <img src="http://localhost:8080/VImage/SWAA/DRAP/DRAP/Y${year}/M${month}/D${date}/drap.jpg" width="300" height="300" onERROR="alert('이미지가 로드되지 않았습니다.')"/> <br>    	    	
		            </div>
		        </div><!--  					
		        
	태양영상 5  --><div class="gr_img_table" >
		            <div class="header">
		                 <h2>
						...
						<div class="gr_graph_table">
							<div class="tableDiv">
								<table class="mtable">
									...
									<tr>
										<td colspan="6" class="tableTitle">방사능 노출 수준 구분(국제방사선방호위원회(ICRP) 기준 준용)</td>									
									</tr>
									<tr>
										<td>방사능 노출 수준</td>
...
<div class="layer" style="top:135px; left:592px;display:none;" id="calendar_image">
	<div class="layer_contents">
        ...
        <p>
        	<label>분</label>
            <select name="" id="calendar_image_min">
