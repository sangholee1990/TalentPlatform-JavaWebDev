		...
		<div class="col-sm-10 col-md-10">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="band_list.do" method="post" name="searchForm" id="searchForm">
				    	...
				    	<div class="form-group">
				    		...
				    		<select class="form-control input-sm"   name="search_target" id="search_target" title="검색">
								...
								<option value="clt_tar_band_kor_nm" <c:if test="${param.search_target eq 'clt_tar_band_kor_nm'}">selected="selected"</c:if> >한글명</option>
								<option value="clt_tar_band_eng_nm" <c:if test="${param.search_target eq 'clt_tar_band_eng_nm'}">selected="selected"</c:if> >영문명</option>
							</select>
   		    ...
   		    <div class="top-button-group">
				<input type="button" class="btn btn-primary btn-sm" id="regBtn" title="밴드등록" value="등록" />
			</div>
	        ...
	        <table class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-3 text-left"><a href="javascript:goView(${o.clt_tar_band_seq_n});"><spring:escapeBody>${o.clt_tar_band_kor_nm}</spring:escapeBody></a></td>
...
$(function() {
	...
	$("#regBtn").click(function() {
		location.href="band_form.do?mode=new";
	});
...
// 	$("#iPage").val(iPage);
// 	$("#searchForm").attr("action", "band_list.do");
// 	$("#searchForm").submit();
// }

//상세보기
function goView(clt_tar_band_seq_n){
	
	$(paramForm).addHidden("view_clt_tar_band_seq_n", clt_tar_band_seq_n);
