		...
		<div class="col-sm-12 col-md-12">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="domain_list_popup.do" method="post" name="searchForm" id="searchForm">
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-4 text-left"><a href="javascript:goSelect(${o.dmn_seq_n},'${o.dmn_kor_nm}');"><spring:escapeBody>${o.dmn_kor_nm}</spring:escapeBody></a></td>
...
function goSelect(seq, nm ){
	window.opener.setDomain(seq, nm);
	window.close();
}
