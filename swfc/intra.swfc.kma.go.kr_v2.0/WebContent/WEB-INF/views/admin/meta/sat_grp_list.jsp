		...
		<div class="col-sm-10 col-md-10">
    		...
    		<nav class="navbar navbar-default" role="navigation">
				<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
			    	<form class="navbar-form navbar-right" role="search" method="post" action="sat_grp_list.do" name="searchForm" id="searchForm">
    		...
    		<table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-4 text-left"><a href="javascript:goView(${o.clt_tar_grp_seq_n});"><spring:escapeBody>${o.clt_tar_grp_kor_nm}</spring:escapeBody></a></td>
...
$(function() {
	$("#regBtn").click(function() {
		location.href="sat_grp_form.do?mode=new";
	});
});
...
// 	$("#iPage").val(iPage);
// 	$("#searchForm").attr("action", "sat_grp_list.do" );
// 	$("#searchForm").submit();
// }

//상세보기
function goView(clt_tar_grp_seq_n){
	
	$(paramForm).addHidden("view_clt_tar_grp_seq_n", clt_tar_grp_seq_n);
