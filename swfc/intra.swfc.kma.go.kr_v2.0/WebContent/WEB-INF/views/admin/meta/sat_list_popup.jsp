		...
		<div class="col-sm-12 col-md-12">
    		...
    		<nav class="navbar navbar-default" role="navigation">
					<div class="collapse navbar-collapse navbar-ex1-collapse text-right">
				    	<form class="navbar-form navbar-right" role="search" action="sat_list_popup.do" method="post" name="searchForm" id="searchForm">
	        ...
	        <table id="searchResultList" class="table table-striped">
	            ...
	            <tr>
	            	...
	            	<td class="col-sm-3 text-left"><a href="javascript:goSelect(${o.clt_tar_seq_n},'${o.clt_tar_kor_nm}', '${o.clt_tar_grp_kor_nm}');"><spring:escapeBody>${o.clt_tar_kor_nm}</spring:escapeBody></a></td>
...
function goSelect(seq, nm, grpNm ){
	window.opener.setSat(seq, nm, grpNm);
	window.close();
}
